...
2. Implement a custom `RolesGuard` that checks whether the user’s roles include the required one  
...
- Avoid hardcoding roles—use centralized logic  
...
I reviewed how to restrict an endpoint so only permitted roles can access it.