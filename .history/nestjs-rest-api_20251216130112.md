...
## Task 39 - Evidence of Implementation

I built a small NestJS REST API for items. It has an Item class, a service that keeps an in-memory list with CRUD, and a controller with routes for GET, POST, PUT, and DELETE. You can test with curl or Postman:
...
- DELETE http://localhost:3000/items/1
  Screenshots will be in tasks/task-039-nestjs-rest-api/screenshots/.
